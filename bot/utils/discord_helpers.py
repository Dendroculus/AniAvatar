...
def create_choices(choices_dict: dict[str, ChoiceT]) -> list[app_commands.Choice[ChoiceT]]:
    """
...
def create_same_choices(choices_list: list[ChoiceT]) -> list[app_commands.Choice[ChoiceT]]:
    """
